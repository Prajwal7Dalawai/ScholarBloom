          ...
          <div className="applied-scholarships-dark card p-3">
            {appliedScholarships.map((scholarship, index) => (
              <div key={index} className="applied-scholarship-item-dark mb-3">
                ...
                <p>
                  <span className="applied-scholarship-label-dark">University:</span> {scholarship.university}
                </p>
                <p>
                  <span className="applied-scholarship-label-dark">Applied Date:</span> {scholarship.applicationDate}
                </p>
                <p>
          ...
          <div className="enrolled-courses-dark card p-3">
            {enrolledCourses.map((course, index) => (
              <div key={index} className="enrolled-course-item-dark mb-3">
                ...
                <p>
                  <span className="enrolled-course-label-dark">Instructor:</span> {course.instructor}
                </p>
                <p>
                  <span className="enrolled-course-label-dark">Start Date:</span> {course.startDate}
                </p>
              </div>
            ))}
          </div>
